...
if __name__ == "__main__":
    ...
    if rhea_id is None:
        raise RuntimeError(f"Did not find Rhea ID in {snakemake.input[0]}, ex. RHEA:12345 or 67890")
    ...
    matching_sequences = swissprot_df[swissprot_df["Rhea ID"].str.contains(rhea_id)]
